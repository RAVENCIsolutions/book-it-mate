...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <section className="relative pt-8 lg:pt-20 pb-5 border-t border-neutral-200 dark:border-neutral-700">
        <article className="container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-y-14 lg:gap-y-10 gap-x-5 sm:gap-x-8 lg:gap-x-10 ">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 col-span-1 sm:col-span-2 md:col-span-4 lg:col-span-1 lg:flex lg:flex-col">
