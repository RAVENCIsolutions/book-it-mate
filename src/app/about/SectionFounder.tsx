...
const SectionFounder = () => {
  return (
    <div className="nc-SectionFounder relative">
      ...
      <div className="text-sm xl:text-base text-neutral-600 dark:text-neutral-400 leading-6 space-y-6">
        <p>
        ...
        <p className={`font-bold`}>Our mission: FIND IT. LOVE IT. BOOK IT</p>
        <p>
