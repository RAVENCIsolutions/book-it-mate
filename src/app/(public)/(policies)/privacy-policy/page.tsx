  ...
  return (
    <main className={`container py-20`}>
      ...
      <p className={`mb-4 text-sm font-light leading-6`}>
        Your privacy is important to us. It is Book It MATE&#39;s policy to
      ...
      <p className={`mb-4 text-sm font-bold`}>
        This policy is effective as of 04 March 2024.{" "}
      </p>
      <p className={`mb-4 text-sm`}>
        Last updated: <span className={`font-bold`}>04 March 2024</span>
      </p>
      ...
      <ul className={`mb-8`}>
        <li
          className={`mb-2 text-sm font-light list-disc list-inside indent-4`}
        >
          Device Type
        </li>
        <li
      ...
      <p className={`mb-4 text-sm font-light leading-6`}>
        ...
        Australia, or where we or our partners, affiliates, and third-party
      ...
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Your choice:</span> By providing
        ...
        if you do not, it may affect your use of our website or the products
      ...
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Marketing permission:</span> If you
        have previously agreed to us using your personal information for direct
        marketing purposes, you may change your mind at any time by contacting
        us using the details below.{" "}
      </p>
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Access:</span> You may request details
        of the personal information that we hold about you.{" "}
      </p>
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Correction:</span> If you believe that
      ...
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Non-discrimination:</span> We will not
        ...
        provide you with a particular service or offer (for example providing
        user support), we will not deny you goods or services and/or charge you
      ...
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Notification of data breaches:</span>{" "}
        We will comply with laws applicable to us in respect of any data breach.{" "}
      </p>
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Complaints:</span> If you believe that
        we have breached a relevant data protection law and wish to make a
        complaint, please contact us using the details below and provide us with
        full details of the alleged breach. We will promptly investigate your
      ...
      <p className={`mb-4 text-sm font-light leading-6`}>
        <span className={`font-semibold`}>Unsubscribe:</span> To unsubscribe
        from our email database or opt-out of communications (including
        marketing communications), please contact us using the details provided
        in this privacy policy, or opt-out using the opt-out facilities provided
        in the communication. We may need to request specific information from
        you to help us confirm your identity.{" "}
      </p>
      <h3 className="mt-8 mb-2 block text-xl font-semibold">Use of Cookies</h3>
      <p className={`mb-4 text-sm font-light leading-6`}>
      ...
      <h3 className="mt-8 mb-2 block text-xl font-semibold">Contact Us</h3>
      <p className={`mb-4 text-sm font-light leading-6`}>
